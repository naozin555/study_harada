    ...
    def execute():
        ...
        for area in area_list:
            ...
            if area == 'Tokyo':
                ...
                raw_data = ServiceKansai.file_open(
                           'area_jyukyu_jisseki_2019.csv')
                header = raw_data[0]
                data_list = raw_data[1]
                datas_list = []
            ...
            if area == 'Tokyo':
                ...
                for month in month_list:
                    ...
                    percentage_month_tokyo = Service.percentage(
                                             sum_month_tokyo)
            ...
            if area == 'Kansai':
                ...
                for month in month_list:
                    ...
                    percentage_month_kansai = ServiceKansai.percentage(
                                              sum_month_kansai)
        ...
        for tokyo_datum in tokyo_data:
            ...
            tokyo_main_power_supply.append(Service.power_supply_analysis
                                           (sorted_tokyo_data))
        kansai_main_power_supply = []
        for kansai_datum in kansai_data:
            sorted_kansai_data = Service.max_sort(kansai_datum)
            kansai_main_power_supply.append(Service.power_supply_analysis
                                            (sorted_kansai_data))
        Service.compare(month_list,
                        tokyo_main_power_supply, kansai_main_power_supply)